...
class OwnThemeFields {
  ...
  // Home Page Colors
  final Color? homePageBottomBarItemColor;
  final Color? homePageBottomBarColor;
  final Color? feedScrollerText;
  final Color? feedScrollerChosenText;
  ...
  const OwnThemeFields(
      ...
      Color? homePageBottomBarItemColor,
      Color? homePageBottomBarColor,
      Color? feedScrollerText,
      Color? feedScrollerChosenText})
      : this.generalReturnColor = generalReturnColor,
        ...
        this.homePageBottomBarItemColor = homePageBottomBarItemColor,
        this.homePageBottomBarColor = homePageBottomBarColor,
        this.feedScrollerText = feedScrollerText,
        this.feedScrollerChosenText = feedScrollerChosenText;
